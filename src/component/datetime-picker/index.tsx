...
const DatetimePicker = (props: DatetimePickerProps) => {
    ...
    function leafMonths(isNext: boolean) {
        let sign = isNext ? 1 : -1;
        setLeftDate(new Date(leftDate.getFullYear(), leftDate.getMonth() + 1 * sign, 1));
        setRightDate(new Date(rightDate.getFullYear(), rightDate.getMonth() + 1 * sign, 1));
    }
    ...
    return (
        <div className={clsx(s['datetime-picker-container'])}>
            ...
            >
                <span className={clsx(s['input-text'])}>
                    {getInputText()}
                </span>
                <img src={calendar} />
            </div>
